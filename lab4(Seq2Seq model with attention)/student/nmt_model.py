...
class NMT(nn.Module):
    ...
    def step(self, Ybar_t: torch.Tensor,
        ...
        ###     2. Use batched matrix multiplication between alpha_t  (b,sor_len) and enc_hiddens(b,sor_len,2*hidden) to obtain the
        ###         attention output vector, a_t.(b,2*hidden)
        # $$     Hints:
